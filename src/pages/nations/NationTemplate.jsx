  ...
  return (
    <div className="nation-page max-w-4xl mx-auto py-12 px-4 font-serif">
      ...
      <div className="mb-8">
        <img 
          src={data.image} 
          alt={`A cultural representation of the ${data.name} people`} 
      ...
      <header className="text-center mb-12">
        <h1 className="text-4xl md:text-6xl font-black text-stone-800 uppercase">{data.name}</h1>
        <p className="text-lg md:text-xl text-stone-600 italic mt-2">"{data.culture}"</p>
      </header>
      ...
      <div className="grid md:grid-cols-2 gap-8 md:gap-10 text-base md:text-lg">
        <div className="bg-white p-6 border border-stone-200 shadow-lg rounded-lg">
          ...
          <p className="text-stone-700 leading-relaxed">{data.origin}</p>
        </div>
        <div className="bg-white p-6 border border-stone-200 shadow-lg rounded-lg">
          <h2 className="text-xl md:text-2xl font-bold text-stone-800 mb-4 border-b-2 border-amber-600 pb-2">Language</h2>
          <p className="text-stone-700 leading-relaxed">The primary language is <strong>{data.language}</strong>.</p>
        </div>
        <div className="bg-white p-6 border border-stone-200 shadow-lg rounded-lg md:col-span-2">
          ...
          <p className="text-stone-700 leading-relaxed">Primarily located in the <strong>{data.location}</strong>.</p>
        </div>
      </div>
