  ...
  return (
    <div className="nation-page max-w-4xl mx-auto py-8 md:py-12 px-4 font-serif">
      ...
      <header className="text-center mb-8 md:mb-12">
        <h1 className="text-4xl md:text-6xl font-black text-stone-800 uppercase">{somaliData.name}</h1>
        <p className="text-base md:text-xl text-stone-600 italic mt-2">"{somaliData.culture}"</p>
      </header>
